...
from jax_training.models_jax import QNN_IBM
...
app = Celery("experiments_IBM_run", broker=broker_url, backend=broker_url)


@app.task
def run_experiment_task_IBM(
    param_dict,
    target_epochs,
    db_path,
    prune_callback,
